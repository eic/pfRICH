...
void reco_simple(const char *dfname, const char *cfname = 0)
{
  auto *reco = new ReconstructionFactory(dfname, cfname, "pfRICH-Simple");
  ...
  // Sensor active area pixelated will be pixellated NxN in digitization; 3.25mm * 400 ~ 1300mm;
