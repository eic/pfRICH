...
void reco_cern(const char *dfname, const char *cfname = 0)
{
  ...
  reco->SetSensorActiveAreaPixellation(64);
  ...
  auto hthtr1 = new TH1D("thtr1",  "Cherenkov angle (track)",        200,  150,    340);
  // For a dual aerogel configuration;
  //auto hthtr2  = new TH1D("thtr2",   "Cherenkov angle (track)",      200,  150,    340);
