...
G4LogicalVolume *DetectorConstruction::BuildHRPPD(G4LogicalVolume *wnd_log, G4Box *pd_box, CherenkovPhotonDetector *pd)
{
...

  {
    ...
    // Create HRPPD QE table; use measurements by Chandra and Ping (April 2026)
    double WL[qeEntries] = {  300, 310, 320, 330, 340, 350, 360, 370, 380, 390, 
                              400, 410, 420, 430, 440, 450, 460, 470, 480, 490, 
			      500, 510, 520, 530, 540, 550, 560, 570, 580, 590, 
			      600};
    double QE[qeEntries] = {0.276867, 0.287487, 0.299343, 0.30702, 0.31969, 0.329561, 0.329503, 0.317338, 0.311426, 0.301849, 
                            0.287044, 0.268918, 0.252113, 0.234045, 0.216861, 0.199069, 0.184133, 0.172104, 0.157094, 0.145769, 
			    0.13266, 0.121514, 0.112, 0.103328, 0.0947434, 0.0869355, 0.0798245, 0.0728552, 0.0662346, 0.0600378, 
			    0.0523486};
#else                               
