...
public:
  ...
  g4dRIChOptics(G4Material *mptr): mat(mptr) {
    materialName = mptr->GetName();
    logicalVName = "_NA_";
...
public:
  ...
  g4dRIChAerogel(G4Material *material) : g4dRIChOptics(material) {};//Name, "_NA_") {};
  //
...
public:
  ...
  g4dRIChFilter(G4Material *material) : g4dRIChOptics(material) {};
...
public:
  ...
  g4dRIChGas(G4Material *material) : g4dRIChOptics(material) {
